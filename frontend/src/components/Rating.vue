      ...
      <v-lazy :options="{
        ...
        <v-card elevation="0">
          ...
          <form @submit.prevent class="p-3">
            <v-rating v-model="newEvent.rate" background-color="grey lighten-2" color="blue" size="50"></v-rating>
            <v-textarea class="mx-2" :rules="rules" v-model="newEvent.comment" label="Komentár" rows="1" prepend-icon="mdi-comment" counter clearable clear-icon="mdi-close-circle"></v-textarea>
            <v-btn class="mt-2" color="blue" @click="addNewEvent" dark block> Pridať hodnotenie </v-btn>
          </form>
        </v-card>
      </v-lazy>
    </v-col>
  ...
  <div class="rates" v-else>
    <v-row no-gutters>
      <v-col cols="12" xl="4" lg="5" md="6" sm="12" xs="12">
        <v-container class="white lighten-5">
          ...
          <v-row no-gutters>
            <v-col cols="12" md="12">
              <h5 class="font-weight-bold"><b style="color: #2196F3">{{this.totalValueOfRate}}</b> na základe {{this.totalRates}} recenzií</h5>
            </v-col>
          </v-row>
          <v-row no-gutters>
            <v-col cols="12" md="12" @click="cardHide = !cardHide">
              <v-rating v-model="this.totalValueOfRate" background-color="grey lighten-2" color="blue" readonly size="50"></v-rating>
            </v-col>
          </v-row>
          <v-spacer></v-spacer>
          ...
          <v-row no-gutters @click="cardHide2 = !cardHide2">
            <v-col cols="12" md="12">
              <v-rating v-model="newEvent2.rate" background-color="grey lighten-2" color="blue" readonly size="30"></v-rating>
            </v-col>
          </v-row>
        </v-container>
      </v-col>
        ...
        <v-container class="white lighten-5">
          <v-row no-gutters>
            <v-col cols="1" md="1" class="m-auto">
              ...
              <v-rating :value="1" :length="1" color="blue lighten-0" background-color="grey lighten-1" readonly small></v-rating>
            </v-col>
            <v-col cols="10" md="10" class="m-auto">
              <div class="bar-container">
                <div class="bar-4" :style="{ width: this.widthFiveStar + '%' }"></div>
              </div>
            </v-col>
            <v-col cols="1" md="1" class="m-auto">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="10" md="10" class="m-auto">
              <div class="bar-container">
                <div class="bar-4" :style="{ width: this.widthFourStar + '%' }"></div>
              </div>
            </v-col>
            <v-col cols="1" md="1" class="m-auto">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="10" md="10" class="m-auto">
              <div class="bar-container">
                <div class="bar-4" :style="{ width: this.widthThreeStar + '%' }"></div>
              </div>
            </v-col>
            <v-col cols="1" md="1" class="m-auto">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="10" md="10" class="m-auto">
              <div class="bar-container">
                <div class="bar-4" :style="{ width: this.widthTwoStar + '%' }"></div>
              </div>
            </v-col>
            <v-col cols="1" md="1" class="m-auto">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="10" md="10" class="m-auto">
              <div class="bar-container">
                <div class="bar-4" :style="{ width: this.widthOneStar + '%' }"></div>
              </div>
            </v-col>
            <v-col cols="1" md="1" class="m-auto">
    ...
    <div class="col" v-if="!cardHide">
      <v-lazy :options="{
        ...
        <v-card elevation="4" tile class="mt-3">
          <v-card-title>
          ...
          <v-data-table :headers="headers" :items="items" :search="search" item-key="name" class="elevation-1" :loading="myloadingvariable" loading-text="Loading... Please wait"></v-data-table>
        </v-card>
      </v-lazy>
    </div>
    <!--change rating-->
    <div class="col" v-if="!cardHide2">
      <v-lazy :options="{
        ...
        <v-card elevation="4" tile class="mt-3">
          ...
          <form @submit.prevent class="p-3">
            <v-rating v-model="newEvent2.rate" background-color="grey lighten-2" color="blue" large></v-rating>
            <v-textarea class="mx-2" :rules="rules" v-model="newEvent2.comment" label="Komentár" rows="1" prepend-icon="mdi-comment" counter clearable clear-icon="mdi-close-circle"></v-textarea>
            <v-btn class="mt-2" color="blue" @click="updateEvent" dark block> Odoslať zmenu </v-btn>
          </form>
        </v-card>
      </v-lazy>
    </div>
