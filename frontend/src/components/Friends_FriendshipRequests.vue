  ...
  <div v-if="btnFriends == true">
        ...
        <v-list-item-content class="justify-center pt-1 pb-0">
          <div class="mx-auto text-center">
            <v-list class="pt-0 pb-0" dense>
              <v-list-item class="p-0 pl-4 pr-4" v-if="$root.friendships.friends.length == 0">
              ...
              <v-list-item class="p-0 pl-4 pr-4" v-else>
              ...
              <v-list-item class="justify-center pl-4 pr-4" v-if="filteredItems.length == 0 && $root.friendships.friends.length != 0" disabled>
              ...
              <v-list-item class="justify-center pl-4 pr-4" v-if="$root.friendships.friends.length == 0 && $root.friendships.friends_overlay == false" disabled>
                <v-list-item-content class="p-2 pr-0 pl-0">
                  <v-card class="rounded-lg card-statement" elevation="0">
            ...
            <v-list class="p-0" dense>
              <v-list-item-group color="primary">
                ...
                <template v-for="(item, index) in filteredItems">
                  ...
                  <v-list-item class="p-0 pl-4 pr-4" :key="item.id">
    ...
    <div class="p-0" v-else>
      ...
      <v-card class="rounded" elevation="0">
        <v-list-item-content class="justify-center pt-1 pb-0">
          <div class="mx-auto text-center">
            <v-list class="pt-0 pb-0 pl-4 pr-4" dense>
    ...
    <div class="p-0 pt-1" v-if="$root.toolbar.friendRequests.friendRequests">
      <v-card class="rounded" elevation="0">
        <v-list-item-content class="justify-center pt-1 pb-0">
          <div class="mx-auto text-center">
            <v-list class="pt-0 pb-0" dense>
              <v-list-item class="p-0 pl-4 pr-4" v-if="$root.toolbar.friendRequests.friendRequests.length == 0">
                <v-text-field class="mt-6" v-model="search" label="Vyhľadať" filled rounded dense append-icon="mdi-magnify" clearable disabled></v-text-field>
              </v-list-item>
              <v-list-item class="p-0 pl-4 pr-4" v-else>
                <v-text-field class="mt-6" v-model="search" label="Vyhľadať" filled rounded dense append-icon="mdi-magnify" clearable></v-text-field>
              ...
              <v-list-item class="justify-center pl-4 pr-4" v-if="filteredFriendRequests.length == 0 && $root.toolbar.friendRequests.friendRequests.length != 0" disabled>
                <v-list-item-content class="p-2 pr-0 pl-0">
                  <v-card class="rounded-lg card-statement" elevation="0">
                    <span>
                      Žiadne žiadosti
              ...
              <v-list-item class="justify-center pl-4 pr-4" v-if="$root.toolbar.friendRequests.friendRequests.length == 0 && $root.toolbar.friendRequests.friendRequests_overlay == false" disabled>
                <v-list-item-content class="p-2 pr-0 pl-0">
                  <v-card class="rounded-lg card-statement" elevation="0">
                    <span>
                      Žiadne žiadosti
