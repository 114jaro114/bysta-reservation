                                                          ...
                                                          <tr>
                                                            <td>
                                                              <table width="170" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                <tbody>
                                                                  <tr>
                                                                    <td><a href="#" style="text-decoration:none;"><img src="{{ asset('images/logo_home_theme_light.png') }}" style="width: 200px;" /></a></multiline></td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                            </td>
                                                              ...
                                                              <td>
                                                                <table  style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;">
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary">Aktivovať účet</button>
                                                                  </td>
                                                                  </tr>
